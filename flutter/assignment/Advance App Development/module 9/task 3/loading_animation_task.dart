...
class LoadingAnimationTask extends StatefulWidget {
  const LoadingAnimationTask({super.key});

  @override
  State<LoadingAnimationTask> createState() => _LoadingAnimationTaskState();
}

class _LoadingAnimationTaskState extends State<LoadingAnimationTask> {
  ...
  void initState() {
    super.initState();
    _weatherFuture = _loadWithDelay();
  }

  Future<Map<String, dynamic>> _loadWithDelay() async {
